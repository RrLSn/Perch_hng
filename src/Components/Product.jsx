...
const Product = () => {
  return (
    <div className={styles.container}>
      <div className="xl:w-[530px] lg:w-[472px] h-[655px] p-[30px] bg-[#F5F5F5] inline-flex">
      ...
      <div className="xl:w-[530px] lg:w-[472px] h-[655px] flex flex-col justify-between gap-[24px]">
        <div className="w-[100%] h-[316px] p-[30px] bg-[#F5F5F5] flex justify-between">
          <div className="w-[176px] h-[100%] flex items-end">
        ...
        <div className="w-[100%] h-[316px] p-[30px] bg-[#F5F5F5] flex justify-between">
          <div className="w-[111px] h-[100%] flex items-end">
